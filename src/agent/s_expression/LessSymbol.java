...
// If the first one is less than the 2nd, the output of the 3rd is returned.
// Otherwise, the output of the 4th is returned.
//
//*****************************************************************************
package agent.s_expression;

public class LessSymbol extends BasicSymbol {
    //*************************************************************************
    // constructors
    //*************************************************************************
    public LessSymbol() {
    ...
    public LessSymbol(Symbol child1, Symbol child2, Symbol child3, 
		      Symbol child4) {
    ...
    //*************************************************************************
    public Symbol copy() {
	return new LessSymbol((children[0]!=null?children[0].copy():null),
