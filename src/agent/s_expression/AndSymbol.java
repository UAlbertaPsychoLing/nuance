...
// AndSymbol.java
//
// Implementation of a function that computes boolean and.
//
//*****************************************************************************
package agent.s_expression;

public class AndSymbol extends BasicSymbol {
    //*************************************************************************
    // constructors
    //*************************************************************************
    public AndSymbol() {
    ...
    public AndSymbol(Symbol child1, Symbol child2) {
    ...
    //*************************************************************************
    public Symbol copy() {
	return new AndSymbol((children[0] != null ? children[0].copy() : null), 
